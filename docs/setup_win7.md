...
* Get Java installed
* Get Leiningen installed <!-- Not sure if needed --> 
* Get Nightcode installed
* Get Git installed (Track 2 only) 
* Test installation
* Troubleshooting
...
<!-- Instructions from https://github.com/ClojureBridge/getting-started/blob/master/nightcode.md go here -EM -->
